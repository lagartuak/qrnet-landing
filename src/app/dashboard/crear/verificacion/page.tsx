...
const MODOS = [
  ...
  },
  {
    slug: 'encuentro',
    emoji: '🤝',
    titulo: 'Encuentro verificado',
    desc: 'Compraventa, quedadas o citas. Ambas personas se verifican mutuamente con QR. Registro con fecha y hora.',
    tags: ['Wallapop', 'Quedadas', 'Seguridad'],
    activo: false,
  },
  {
    slug: 'entrega',
    ...
    desc: 'Confirma la identidad del destinatario al entregar un paquete o documento. Comprobante digital automático.',
