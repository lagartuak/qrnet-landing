...
const tipos = [
  ...
  slug: 'bicicleta',
  emoji: '🚲',
  titulo: 'Bicicleta / Patinete',
  desc: 'Bicicletas, e-bikes y patinetes eléctricos. Contacto anónimo, alerta de robo y verificación de segunda mano.',
  tags: ['Contacto anónimo', 'Antirrobo', 'Segunda mano'],
  activo: true,
},
  {
    slug: 'mascota',
