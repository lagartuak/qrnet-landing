...
export default function MaquinaTabacoPage() {
  ...
  const [form, setForm] = useState({
    ...
    pvr_caducidad: '',
    // Tipo
    tipo_maquina: 'tabaco', // tabaco | vending
    // Notas
    observaciones: '',
  });
    ...
    <div className="crear-wrap">
      ...
      <div className="maquina-form">
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            <div className="form-field full">
              ...
              <input
                type="text"
                placeholder="Ej: Bar El Rincón / Estanco Hernández"
                value={form.estab_nombre}
            ...
            <div className="form-field full">
              ...
              <input
                type="text"
                placeholder="Ej: Calle Gayarre 12"
                value={form.estab_dir}
        ...
        {form.tipo_maquina === 'tabaco' && (
          <div className="form-section">
            <div className="form-section-title">
              Tasa PVR · Permiso de Venta en Ruta
            </div>
        ...
        <div className="form-section">
          ...
          <textarea
            rows={3}
            placeholder="Notas adicionales sobre la máquina o la ubicación..."
